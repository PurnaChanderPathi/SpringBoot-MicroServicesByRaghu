...
public class EmployeeController {
	...
	// when end user enter / register eith GET Type
	@GetMapping("/register")
	 ...
	 * It will make call to service method by passing same from object
	 ...
	 * In UI use th:each="ob(tempVariable):${list(collectionName)}" to read data
...
//	}
	 ...
	 * When enduser clicks on EDIT link, internal request looks like /edit?empId=10
